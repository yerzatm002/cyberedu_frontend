    ...
    <MainLayout user={user}>
      <div>
        ...
        <p className="mt-2 text-gray-600">
          Бұл бөлімде барлық қолжетімді сабақтар көрсетіледі.
        </p>

        <div className="mt-8 grid gap-6 md:grid-cols-2">
          {mockLessons.map((lesson, index) => {
            const isLocked =
              index > 0 && !mockLessons[index - 1].completed && !lesson.completed
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <p className="text-sm text-gray-500">Сабақ #{lesson.id}</p>
                ...
                <p className="mt-3 text-sm text-gray-600">Блок: {lesson.block}</p>
